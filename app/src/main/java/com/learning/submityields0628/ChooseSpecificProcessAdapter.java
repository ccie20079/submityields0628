...
public class ChooseSpecificProcessAdapter extends ArrayAdapter<V_Specific_Process> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.textViewOfManHour.setText(v_specific_process.getMan_hours());
        viewHolder.textViewOfLabourCost.setText(v_specific_process.getLabour_cost());
        viewHolder.textViewOfSeq_P_C_Record.setText(v_specific_process.getSeq_p_c_record());
        return view;
    }
    class ViewHolder{
        CheckBox checkboxOfSpecificProcess;
